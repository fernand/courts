...
echo "Loading schema to database: schema-2024-12-31.sql"
psql -f "$BULK_DIR"/schema-2024-12-31.sql --host "$BULK_DB_HOST" --username "$BULK_DB_USER"

echo "Loading people-db-people-2024-12-31.csv to database"
psql --command "\COPY public.people_db_person (
	   ...
	   ) FROM '$BULK_DIR/people-db-people-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading people_db_race-2024-12-31.csv to database"
psql --command "\COPY public.people_db_race (id, race) FROM '$BULK_DIR/people_db_race-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading people-db-schools-2024-12-31.csv to database"
psql --command "\COPY public.people_db_school (
	       id, date_created, date_modified, name, ein, is_alias_of_id
	   ) FROM '$BULK_DIR/people-db-schools-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"
...
echo "Loading people-db-positions-2024-12-31.csv to database"
psql --command "\COPY public.people_db_position (
	       ...
	       supervisor_id
	   ) FROM '$BULK_DIR/people-db-positions-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading fjc-integrated-database-2024-12-31.csv to database"
psql --command "\COPY public.recap_fjcintegrateddatabase (
	   ...
	   ) FROM '$BULK_DIR/fjc-integrated-database-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"
...
echo "Loading oral-arguments-2024-12-31.csv to database"
psql --command "\COPY public.audio_audio (
	   ...
	   ) FROM '$BULK_DIR/oral-arguments-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading people-db-retention-events-2024-12-31.csv to database"
psql --command "\COPY public.people_db_retentionevent (
	       ...
	       won, position_id
	   ) FROM '$BULK_DIR/people-db-retention-events-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading people-db-educations-2024-12-31.csv to database"
psql --command "\COPY public.people_db_education (
	   ...
	   ) FROM '$BULK_DIR/people-db-educations-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading people-db-political-affiliations-2024-12-31.csv to database"
psql --command "\COPY public.people_db_politicalaffiliation (
	   ...
	   ) FROM '$BULK_DIR/people-db-political-affiliations-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading people-db-races-2024-12-31.csv to database"
psql --command "\COPY public.people_db_person_race (
	       id, person_id, race_id
	   ) FROM '$BULK_DIR/people-db-races-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-2024-12-31.csv to database"
psql --command "\COPY public.disclosures_financialdisclosure (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosures-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosure-investments-2024-12-31.csv to database"
psql --command "\COPY public.disclosures_investment (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosure-investments-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-positions-2024-12-31.csv to database"
psql --command "\COPY public.disclosures_position (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosures-positions-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-agreements-2024-12-31.csv to database"
psql --command "\COPY public.disclosures_agreement (
	       id, date_created, date_modified, date_raw, parties_and_terms,
	       redacted, financial_disclosure_id
	   ) FROM '$BULK_DIR/financial-disclosures-agreements-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-non-investment-income-2024-12-31.csv to database"
psql --command "\COPY public.disclosures_noninvestmentincome (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosures-non-investment-income-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-spousal-income-2024-12-31.csv to database"
psql --command "\COPY public.disclosures_spouseincome (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosures-spousal-income-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-reimbursements-2024-12-31.csv to database"
psql --command "\COPY public.disclosures_reimbursement (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosures-reimbursements-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-gifts-2024-12-31.csv to database"
psql --command "\COPY public.disclosures_gift (
	       id, date_created, date_modified, source, description, value,
	       redacted, financial_disclosure_id
	   ) FROM '$BULK_DIR/financial-disclosures-gifts-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"

echo "Loading financial-disclosures-debts-2024-12-31.csv to database"
psql --command "\COPY public.disclosures_debt (
	   ...
	   ) FROM '$BULK_DIR/financial-disclosures-debts-2024-12-31.csv' WITH (FORMAT csv, ENCODING utf8, QUOTE \'`\', HEADER)" --host "$BULK_DB_HOST" --username "$BULK_DB_USER" --dbname "$BULK_DB_NAME"
